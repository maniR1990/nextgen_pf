...
export function FormField({ label, htmlFor, error, hint, required, badge, children, className = '', ...props }: FormFieldProps) {
  return (
    <div className={['form-field', error && 'form-field--error', className].filter(Boolean).join(' ')} {...props}>
