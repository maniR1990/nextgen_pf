...
export const CreatePaymentSourceSchema = z.object({
  ...
  type: z.enum([
    'BANK_SALARY', 'BANK_SAVINGS', 'BANK_CURRENT', 'CREDIT_CARD',
    'CASH_WALLET', 'ATM_CASH', 'GIFT_CARD', 'CASH_GIFT',
    'DIGITAL_WALLET', 'UPI', 'COUPON_WALLET', 'POINTS_WALLET',
    'STORE_CREDIT', 'INVESTMENT_ACC', 'SUKANYA', 'FD', 'PPF', 'NPS',
  ]),
